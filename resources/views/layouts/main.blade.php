         ...
         <div class="col-sm-12 main-b">
            <div class="col-sm-2">
               ...
               <ul class="link">
                  ...
                  <li><a href="http://www.edmontonautoloans.com/vehicles/search">» Used Vehicles</a></li>
            ...
            <div class="col-sm-3">
               <ul class="link adres">
                  <li><a title="6211 104 Street Edmonton AB"><i class="fa fa-map-marker"></i>28520 114 Ave, Acheson, AB T7X-6E6</a></li>
